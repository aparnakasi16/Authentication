class Form {
  constructor() {
    ...
    this.input3 = createInput("").attribute("placeholder", "Enter username");
    this.input5 = createInput("").attribute("placeholder", "Enter password")
